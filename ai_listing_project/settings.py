...
SECRET_KEY = 'django-insecure-v(_zajvkuv4ruz*7j0a)da(#vkfb@z^j20iu(3tra#1a33$fk^'
...
if EMAIL_PORT == 587 and not EMAIL_USE_TLS:
    ...
    EMAIL_USE_SSL = True
EMAIL_HOST_USER = os.environ.get('EMAIL_HOST_USER', '2510927347@qq.com')
EMAIL_HOST_PASSWORD = os.environ.get('EMAIL_HOST_PASSWORD', 'pyvrwcmqpvqzdjhc')
DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL', EMAIL_HOST_USER or '2510927347@qq.com')


# OpenAI / 兼容代理（与 script/CLose_AI_test.py 一致，通过环境变量注入密钥）
OPENAI_API_KEY = os.environ.get("OPENAI_API_KEY", "sk-vzcf3MNFhMoveatXo88kt74Cspu1CB5ao4Uh4reoulooV2cI")
...
NANO_BANANA_API_KEY = os.environ.get("NANO_BANANA_API_KEY", "sk-8a6dc9f2e6cf4c43907011d2215e3b52")
...
AMAZON_IMAGE_WEBHOOK_URL = os.environ.get(
    "AMAZON_IMAGE_WEBHOOK_URL",
    "http://192.168.93.129:5678/webhook/9392a935-f245-4c87-8ca1-amazonimage0002",
)
